...
if button:
    if st.session_state.left_language == 'Burmese':
        ...
        st.markdown(f"""<div ><span style='color: red; font-size:16px; padding:30px;'>*** Notes: English လို Convert ရာတွင် တချို့သော နာမည်များသည် စာလုံးများတူနေသောကြောင့် ဖြစ်နိုင်သောနာမည်များကိုထုတ်ပြပေးထားသည်။ **</span></div>""", unsafe_allow_html=True)
